			...
			function drawChart() {
				...
				if(_ecoFisioValues.length > 0) {
					...
					if (graphData.length > 1 ) {
						...
						var chart = new google.visualization.LineChart(document.getElementById('ecoFisioWI_NDVIGraph'));
	  			...
	  			<div class="col-xs-12 col-lg-12">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title">WI and NDVI / Xylem Water 18O</h3>
						</div>
						<div class="panel-body">
							<div id="ecoFisioWI_NDVIGraph">
								<?
